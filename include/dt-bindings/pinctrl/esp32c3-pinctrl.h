...
#define I2S1_I_SD1_OUT_GPIO0 \
	ESP32_PINMUX(0, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO1 \
	ESP32_PINMUX(1, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO2 \
	ESP32_PINMUX(2, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO3 \
	ESP32_PINMUX(3, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO4 \
	ESP32_PINMUX(4, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO5 \
	ESP32_PINMUX(5, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO6 \
	ESP32_PINMUX(6, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO7 \
	ESP32_PINMUX(7, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO8 \
	ESP32_PINMUX(8, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO9 \
	ESP32_PINMUX(9, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO10 \
	ESP32_PINMUX(10, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO11 \
	ESP32_PINMUX(11, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO12 \
	ESP32_PINMUX(12, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO13 \
	ESP32_PINMUX(13, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO14 \
	ESP32_PINMUX(14, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO15 \
	ESP32_PINMUX(15, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO16 \
	ESP32_PINMUX(16, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO17 \
	ESP32_PINMUX(17, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO18 \
	ESP32_PINMUX(18, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO19 \
	ESP32_PINMUX(19, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO20 \
	ESP32_PINMUX(20, ESP_NOSIG, ESP_I2SI_SD1_OUT)

#define I2S1_I_SD1_OUT_GPIO21 \
	ESP32_PINMUX(21, ESP_NOSIG, ESP_I2SI_SD1_OUT)
...
#define I2S1_SD_GPIO0 \
	ESP32_PINMUX(0, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO1 \
	ESP32_PINMUX(1, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO2 \
	ESP32_PINMUX(2, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO3 \
	ESP32_PINMUX(3, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO4 \
	ESP32_PINMUX(4, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO5 \
	ESP32_PINMUX(5, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO6 \
	ESP32_PINMUX(6, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO7 \
	ESP32_PINMUX(7, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO8 \
	ESP32_PINMUX(8, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO9 \
	ESP32_PINMUX(9, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO10 \
	ESP32_PINMUX(10, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO11 \
	ESP32_PINMUX(11, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO12 \
	ESP32_PINMUX(12, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO13 \
	ESP32_PINMUX(13, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO14 \
	ESP32_PINMUX(14, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO15 \
	ESP32_PINMUX(15, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO16 \
	ESP32_PINMUX(16, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO17 \
	ESP32_PINMUX(17, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO18 \
	ESP32_PINMUX(18, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO19 \
	ESP32_PINMUX(19, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO20 \
	ESP32_PINMUX(20, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)

#define I2S1_SD_GPIO21 \
	ESP32_PINMUX(21, ESP_I2SI_SD_IN, ESP_I2SO_SD_OUT)
