...
#ifdef CONFIG_ESP32_BT_LE_HCI_INTERFACE_USE_UART
...
#define CONFIG_ESP32_BT_CTLR_DFT_TX_POWER_LEVEL_EFF -18
#elif defined(CONFIG_BT_CTLR_TX_PWR_MINUS_21)
#define CONFIG_ESP32_BT_CTLR_DFT_TX_POWER_LEVEL_EFF -21
#elif defined(CONFIG_BT_CTLR_TX_PWR_MINUS_24)
#define CONFIG_ESP32_BT_CTLR_DFT_TX_POWER_LEVEL_EFF -24
#else
...
#define BT_CONTROLLER_INIT_CONFIG_DEFAULT() {                                           \
    ...
    .ble_ll_tx_pwr_dbm = CONFIG_ESP32_BT_CTRL_DFT_TX_POWER_LEVEL_EFF,                   \
    .rtc_freq = RTC_FREQ_N,                                                             \
    ...
    .ch39_txpwr                 = CONFIG_ESP32_BT_CTRL_DFT_TX_POWER_LEVEL_EFF,          \
