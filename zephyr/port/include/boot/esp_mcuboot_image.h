...
#define ESP_PROGRAM_HEADER_MAGIC ESP_LOAD_HEADER_MAGIC

/* Load header that should be a part of application image
 * for MCUboot-Espressif port booting.
 * The header can use up to 96 Bytes (or 24 DWords).
 */
...
typedef esp_program_header_t esp_image_load_header_t;
