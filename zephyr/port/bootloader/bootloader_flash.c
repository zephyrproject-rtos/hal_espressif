...
/* ROM-based flash functions for simpleboot */
#if CONFIG_IDF_TARGET_ESP32
...
IRAM_ATTR uint32_t bootloader_flash_execute_command_common(
    ...
    uint8_t miso_len)
{
    HAL_ASSERT(mosi_len <= 32);
    HAL_ASSERT(miso_len <= 32);
