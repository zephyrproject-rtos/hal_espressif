...
#define NIMBLE_LL_STACK_SIZE CONFIG_ESP32_BT_LE_CONTROLLER_TASK_STACK_SIZE
    ...
    #if defined(CONFIG_ESP32_BT_LE_LL_CFG_FEAT_LE_2M_PHY)
        #define DEGAULT_BT_LE_2M_PHY (CONFIG_ESP32_BT_LE_LL_CFG_FEAT_LE_2M_PHY)
    #else
        #define DEGAULT_BT_LE_2M_PHY (0)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_LL_CFG_FEAT_LE_CODED_PHY)
        #define DEGAULT_BT_LE_CODED_PHY (CONFIG_ESP32_BT_LE_LL_CFG_FEAT_LE_CODED_PHY)
    #else
        #define DEGAULT_BT_LE_CODED_PHY (0)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_EXT_ADV)
        #define DEFAULT_BT_LE_EXT_ADV       (CONFIG_ESP32_BT_LE_EXT_ADV)
    #else
        #define DEFAULT_BT_LE_EXT_ADV       (0)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_ENABLE_PERIODIC_ADV)
        #define DEFAULT_BT_LE_PERIODIC_ADV  (CONFIG_ESP32_BT_LE_ENABLE_PERIODIC_ADV)
    #else
        #define DEFAULT_BT_LE_PERIODIC_ADV  (0)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_EXT_SCAN)
        #define DEFAULT_BT_LE_EXT_SCAN      (CONFIG_ESP32_BT_LE_EXT_SCAN)
    #else
        #define DEFAULT_BT_LE_EXT_SCAN      (0)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_ENABLE_PERIODIC_SYNC)
        #define DEFAULT_BT_LE_PERIODIC_SYNC  (CONFIG_ESP32_BT_LE_ENABLE_PERIODIC_SYNC)
    #else
    ...
    #if defined(CONFIG_ESP32_BT_LE_ROLE_CENTROL_ENABLE)
        #define DEFAULT_BT_LE_ROLE_CENTROL (1)
    #else
        #define DEFAULT_BT_LE_ROLE_CENTROL (0)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_ROLE_PERIPHERAL_ENABLE)
        #define DEFAULT_BT_LE_ROLE_PERIPHERAL (1)
    #else
        #define DEFAULT_BT_LE_ROLE_PERIPHERAL (0)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_ROLE_BROADCASTER_ENABLE)
        #define DEFAULT_BT_LE_ROLE_BROADCASTER (1)
    #else
        #define DEFAULT_BT_LE_ROLE_BROADCASTER (0)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_ROLE_OBSERVER_ENABLE)
        #define DEFAULT_BT_LE_ROLE_OBSERVER (1)
    #else
        #define DEFAULT_BT_LE_ROLE_OBSERVER (0)
    #endif
    #if defined (CONFIG_ESP32_BT_LE_HCI_UART_FLOWCTRL)
        #define DEFAULT_BT_LE_HCI_UART_FLOW_CTRL (CONFIG_ESP32_BT_LE_HCI_UART_FLOWCTRL)
        #if DEFAULT_BT_LE_HCI_UART_FLOW_CTRL
            #define DEFAULT_BT_LE_HCI_UART_CTS_PIN (CONFIG_ESP32_BT_LE_HCI_UART_CTS_PIN)
            #define DEFAULT_BT_LE_HCI_UART_RTS_PIN (CONFIG_ESP32_BT_LE_HCI_UART_RTS_PIN)
        #else
...
#ifdef CONFIG_ESP32_BT_LE_CTRL_CHECK_CONNECT_IND_ACCESS_ADDRESS
#define DEFAULT_BT_LE_CTRL_CHECK_CONNECT_IND_ACCESS_ADDRESS  (CONFIG_ESP32_BT_LE_CTRL_CHECK_CONNECT_IND_ACCESS_ADDRESS)
#else
#define DEFAULT_BT_LE_CTRL_CHECK_CONNECT_IND_ACCESS_ADDRESS  (0)
#endif

#ifdef CONFIG_ESP32_BT_LE_CTRL_LLCP_CONN_UPDATE
#define BT_CTRL_BLE_LLCP_CONN_UPDATE (1<<0)
#else
#define BT_CTRL_BLE_LLCP_CONN_UPDATE (0<<0)
#endif

#ifdef CONFIG_ESP32_BT_LE_CTRL_LLCP_CHAN_MAP_UPDATE
#define BT_CTRL_BLE_LLCP_CHAN_MAP_UPDATE (1<<1)
#else
#define BT_CTRL_BLE_LLCP_CHAN_MAP_UPDATE (0<<1)
#endif

#ifdef CONFIG_ESP32_BT_LE_CTRL_LLCP_PHY_UPDATE
...
#define HCI_UART_EN CONFIG_ESP32_BT_LE_HCI_INTERFACE_USE_UART
#else
...
#if HCI_UART_EN
    #define DEFAULT_BT_LE_HCI_UART_TX_PIN (CONFIG_ESP32_BT_LE_HCI_UART_TX_PIN)
    #define DEFAULT_BT_LE_HCI_UART_RX_PIN (CONFIG_ESP32_BT_LE_HCI_UART_RX_PIN)
    #define DEFAULT_BT_LE_HCI_UART_PORT (CONFIG_ESP32_BT_LE_HCI_UART_PORT)
    #define DEFAULT_BT_LE_HCI_UART_BAUD (CONFIG_ESP32_BT_LE_HCI_UART_BAUD)
...
#if defined(CONFIG_XTAL_FREQ_HZ)
...
#endif
#else
    #error CONFIG_XTAL_FREQ_HZ is undefined
#endif
