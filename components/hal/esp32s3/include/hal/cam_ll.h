...
{
    (void)group_id;
    return LCD_CAM.lcd_clock.clk_en;
}
...
static inline void cam_ll_get_clk_src(lcd_cam_dev_t *dev, cam_clock_source_t *src)
{
    ...
    case 1:
        *src = LCD_CLK_SRC_XTAL;
        break;
    case 2:
        *src = LCD_CLK_SRC_PLL240M;
        break;
    case 3:
        *src = LCD_CLK_SRC_PLL160M;
        break;
    default:
        HAL_ASSERT(false);
        break;
...
static inline void cam_ll_set_group_clock_coeff(int group_id, int div_num, int div_a, int div_b)
{
    ...
    HAL_FORCE_MODIFY_U32_REG_FIELD(LCD_CAM.cam_ctrl, cam_clkm_div_num, div_num);
