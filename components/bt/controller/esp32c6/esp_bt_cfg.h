...
#define NIMBLE_LL_STACK_SIZE CONFIG_ESP32_BT_LE_CONTROLLER_TASK_STACK_SIZE
    ...
    #if CONFIG_ESP32_BT_LE_LL_CFG_FEAT_LE_CODED_PHY
    #define BLE_LL_SCAN_PHY_NUMBER_N (2)
    #else
    #define BLE_LL_SCAN_PHY_NUMBER_N (1)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_MAX_PERIODIC_ADVERTISER_LIST)
        #define DEFAULT_BT_LE_MAX_PERIODIC_ADVERTISER_LIST (CONFIG_ESP32_BT_LE_MAX_PERIODIC_ADVERTISER_LIST)
    #else
        #define DEFAULT_BT_LE_MAX_PERIODIC_ADVERTISER_LIST (5)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_MAX_PERIODIC_SYNCS)
        #define DEFAULT_BT_LE_MAX_PERIODIC_SYNCS (CONFIG_ESP32_BT_LE_MAX_PERIODIC_SYNCS)
    #else
        #define DEFAULT_BT_LE_MAX_PERIODIC_SYNCS (1)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_MAX_CONNECTIONS)
        #define DEFAULT_BT_LE_MAX_CONNECTIONS (CONFIG_ESP32_BT_LE_MAX_CONNECTIONS)
    #else
        #define DEFAULT_BT_LE_MAX_CONNECTIONS (2)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_PERIODIC_ADV_WITH_RESPONSE_ENABLED)
        #define DEFAULT_BT_LE_PAWR_SUPPORTED (CONFIG_ESP32_BT_LE_PERIODIC_ADV_WITH_RESPONSE_ENABLED)
    #else
        #define DEFAULT_BT_LE_PAWR_SUPPORTED (0)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_ACL_BUF_SIZE)
        #define DEFAULT_BT_LE_ACL_BUF_SIZE (CONFIG_ESP32_BT_LE_ACL_BUF_SIZE)
    #else
    ...
    #if defined(CONFIG_ESP32_BT_LE_HCI_EVT_BUF_SIZE)
        #define DEFAULT_BT_LE_HCI_EVT_BUF_SIZE (CONFIG_ESP32_BT_LE_HCI_EVT_BUF_SIZE)
    #else
        #define DEFAULT_BT_LE_HCI_EVT_BUF_SIZE (70)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_EXT_ADV_MAX_SIZE)
        #define DEFAULT_BT_LE_EXT_ADV_MAX_SIZE (CONFIG_ESP32_BT_LE_EXT_ADV_MAX_SIZE)
    #else
        #define DEFAULT_BT_LE_EXT_ADV_MAX_SIZE (31)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_MAX_EXT_ADV_INSTANCES)
        #define DEFAULT_BT_LE_MAX_EXT_ADV_INSTANCES (CONFIG_ESP32_BT_LE_MAX_EXT_ADV_INSTANCES)
    #else
        #define DEFAULT_BT_LE_MAX_EXT_ADV_INSTANCES (1)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_WHITELIST_SIZE)
        #define DEFAULT_BT_NIMBLE_WHITELIST_SIZE (CONFIG_ESP32_BT_LE_WHITELIST_SIZE)
    #else
    ...
    #if defined(CONFIG_ESP32_BT_LE_HCI_EVT_LO_BUF_COUNT)
        #define DEFAULT_BT_LE_HCI_EVT_LO_BUF_COUNT (CONFIG_ESP32_BT_LE_HCI_EVT_LO_BUF_COUNT)
    #else
        #define DEFAULT_BT_LE_HCI_EVT_LO_BUF_COUNT (8)
    #endif

    #if defined(CONFIG_ESP32_BT_LE_POWER_CONTROL_ENABLED)
        #define DEFAULT_BT_LE_POWER_CONTROL_ENABLED (CONFIG_ESP32_BT_LE_POWER_CONTROL_ENABLED)
    #else
    ...
    #elif defined(CONFIG_ESP32_BT_LE_SUBRATE_ENABLED)
        #define DEFAULT_BT_LE_SUBRATE_ENABLED (CONFIG_ESP32_BT_LE_SUBRATE_ENABLED)
    #else
        #define DEFAULT_BT_LE_SUBRATE_ENABLED (0)
    #endif
    #if defined(CONFIG_ESP32_BT_LE_50_FEATURE_SUPPORT)
        #define DEFAULT_BT_LE_50_FEATURE_SUPPORT (1)
    #else
        #define DEFAULT_BT_LE_50_FEATURE_SUPPORT (0)
    #endif
...
#define DEFAULT_BT_LE_COEX_PHY_CODED_TX_RX_TLIM_EFF CONFIG_ESP32_BT_LE_COEX_PHY_CODED_TX_RX_TLIM_EFF

#ifdef CONFIG_ESP32_BT_LE_CTLR_CHECK_CONNECT_IND_ACCESS_ADDRESS
#define DEFAULT_BT_LE_CTRL_CHECK_CONNECT_IND_ACCESS_ADDRESS  (CONFIG_ESP32_BT_LE_CTLR_CHECK_CONNECT_IND_ACCESS_ADDRESS)
#else
#define DEFAULT_BT_LE_CTRL_CHECK_CONNECT_IND_ACCESS_ADDRESS  (0)
#endif

#ifdef CONFIG_ESP32_BT_LE_CTLR_LLCP_CONN_UPDATE
#define BT_CTRL_BLE_LLCP_CONN_UPDATE (1<<0)
#else
#define BT_CTRL_BLE_LLCP_CONN_UPDATE (0<<0)
#endif

#ifdef CONFIG_ESP32_BT_LE_CTLR_LLCP_CHAN_MAP_UPDATE
#define BT_CTRL_BLE_LLCP_CHAN_MAP_UPDATE (1<<1)
#else
#define BT_CTRL_BLE_LLCP_CHAN_MAP_UPDATE (0<<1)
#endif

#ifdef CONFIG_ESP32_BT_LE_CTLR_LLCP_PHY_UPDATE
...
#if defined(CONFIG_ESP32_BT_LE_CTLR_CHAN_ASS_EN)
#define DEFAULT_BT_LE_CTRL_CHAN_ASS_EN (CONFIG_ESP32_BT_LE_CTLR_CHAN_ASS_EN)
#else
#define DEFAULT_BT_LE_CTRL_CHAN_ASS_EN (0)
#endif

#if defined(CONFIG_ESP32_BT_LE_CTLR_ADV_DATA_LENGTH_ZERO_AUX)
#define DEFAULT_BT_LE_CTRL_ADV_DATA_LENGTH_ZERO_AUX (CONFIG_ESP32_BT_LE_CTLR_ADV_DATA_LENGTH_ZERO_AUX)
#else
#define DEFAULT_BT_LE_CTRL_ADV_DATA_LENGTH_ZERO_AUX (0)
#endif

#if defined(CONFIG_ESP32_BT_LE_CTLR_FAST_CONN_DATA_TX_EN)
#define DEFAULT_BT_LE_CTRL_FAST_CONN_DATA_TX_EN (CONFIG_ESP32_BT_LE_CTLR_FAST_CONN_DATA_TX_EN)
#else
#define DEFAULT_BT_LE_CTRL_FAST_CONN_DATA_TX_EN (0)
#endif

#if defined(CONFIG_ESP32_BT_LE_CTLR_SLV_FAST_RX_CONN_DATA_EN)
#define DEFAULT_BT_LE_CTRL_SLV_FAST_RX_CONN_DATA_EN (CONFIG_ESP32_BT_LE_CTLR_SLV_FAST_RX_CONN_DATA_EN)
#else
#define DEFAULT_BT_LE_CTRL_SLV_FAST_RX_CONN_DATA_EN (0)
#endif


#if defined(CONFIG_ESP32_BT_LE_CTLR_DL_ITVL_PHY_SYNC_EN)
#define DEFAULT_BT_LE_CTRL_DL_ITVL_PHY_SYNC_EN (CONFIG_ESP32_BT_LE_CTLR_DL_ITVL_PHY_SYNC_EN)
#else
...
#ifdef CONFIG_ESP32_BT_LE_HCI_INTERFACE_USE_RAM
#define DEFAULT_BT_LE_VHCI_ENABLED      (CONFIG_ESP32_BT_LE_HCI_INTERFACE_USE_RAM)
#else
...
#define NIMBLE_SLEEP_ENABLE CONFIG_ESP32_BT_LE_SLEEP_ENABLE
#else
#define NIMBLE_SLEEP_ENABLE  0
#endif


#ifdef CONFIG_ESP32_BT_LE_TX_CCA_ENABLED
    #define DEFAULT_BT_LE_TX_CCA_ENABLED (CONFIG_ESP32_BT_LE_TX_CCA_ENABLED)
#else
    #define DEFAULT_BT_LE_TX_CCA_ENABLED (0)
#endif

#ifdef CONFIG_ESP32_BT_LE_CCA_RSSI_THRESH
    #define DEFAULT_BT_LE_CCA_RSSI_THRESH (CONFIG_ESP32_BT_LE_CCA_RSSI_THRESH)
#else
...
#ifdef CONFIG_ESP32_BT_LE_CTLR_ADV_FAST_TX_EN
...
#ifdef CONFIG_ESP32_BT_LE_CTLR_ADV_FAST_TX_EN
#define DEFAULT_BT_LE_CTRL_RXBUF_MEM_RESV CONFIG_ESP32_BT_LE_CTLR_ADV_FAST_TX_EN
#else
#define DEFAULT_BT_LE_CTRL_RXBUF_MEM_RESV  (0)
#endif

#ifdef CONFIG_ESP32_BT_LE_CTLR_ADV_EVENT_INC_ON_FULL_TX_EN
#define DEFAULT_BT_LE_CTRL_ADV_EVENT_INC_ON_FULL_TX_EN (1<<0)
#else
#define DEFAULT_BT_LE_CTRL_ADV_EVENT_INC_ON_FULL_TX_EN (0)
#endif

#ifdef CONFIG_ESP32_BT_LE_CTLR_ADV_CH38_39_TX_AVOID_CONFLICT_EN
...
#define BLE_CH39_TX_PWR_DBM_N       (CONFIG_ESP32_BT_CTRL_DFT_TX_POWER_LEVEL_EFF)
#else
#define DEFAULT_BT_LE_ADV_CH39_TXPWR_CONFIG_SEPARATELY_EN (0)
#define BLE_CH39_TX_PWR_DBM_N       (CONFIG_ESP32_BT_CTRL_DFT_TX_POWER_LEVEL_EFF)
#endif

#ifdef CONFIG_ESP32_BT_LE_CTLR_ADV_TX_CONTINUE_WHEN_EXCEED_ITVL_EN
...
#ifdef CONFIG_ESP32_BT_LE_CTLR_ADV_RAND_CH_IDX_EN
...
#define BLE_LL_TX_PWR_DBM_N                 (CONFIG_ESP32_BT_CTRL_DFT_TX_POWER_LEVEL_EFF)

#define BLE_LL_ADV_SM_RESERVE_CNT_N         MIN(DEFAULT_BT_LE_MAX_EXT_ADV_INSTANCES, 2)
#define BLE_LL_CONN_SM_RESERVE_CNT_N        MIN(DEFAULT_BT_LE_MAX_CONNECTIONS, 2)

#define RUN_BQB_TEST                        (0)
#define RUN_QA_TEST                         (0)
#define NIMBLE_DISABLE_SCAN_BACKOFF         (0)
#define BT_LL_CTRL_PRIO_LVL_CFG ((1 << 4) | (1 << 2) | 0)
